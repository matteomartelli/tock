...
impl IoWrite for Writer {
    fn write(&mut self, buf: &[u8]) -> usize {
        ...
        let periph_clocks:stm32f429zi::clocks::PeripheralClocks<Stm32f429Specs> =
            stm32f429zi::clocks::PeripheralClocks::new(&rcc, &clocks);

        let uart = stm32f429zi::usart::Usart::new_usart3(&periph_clocks.usart3);
...
pub unsafe fn panic_fmt(info: &PanicInfo) -> ! {
    ...
    let syscfg = stm32f429zi::syscfg::Syscfg::new(&periph_clocks.syscfg);
    let exti = stm32f429zi::exti::Exti::new(&syscfg);
    let pin = stm32f429zi::gpio::Pin::new(PinId::PB07, &exti);
    let gpio_ports = stm32f429zi::gpio::GpioPorts::new(periph_clocks.get_gpio_ports(), &exti);

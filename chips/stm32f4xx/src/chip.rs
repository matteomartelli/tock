...
pub struct Stm32f4xxDefaultPeripherals<'a, ChipSpecs> {
    pub adc1: crate::adc::Adc<'a, ChipSpecs>,
    pub dac: crate::dac::Dac<'a, ChipSpecs>,
    pub dma1_streams: [crate::dma::Stream<'a, dma::Dma1<'a, ChipSpecs>>; 8],
    pub dma2_streams: [crate::dma::Stream<'a, dma::Dma2<'a, ChipSpecs>>; 8],
    pub exti: &'a crate::exti::Exti<'a, ChipSpecs>,
    pub flash: crate::flash::Flash<ChipSpecs>,
    pub fsmc: crate::fsmc::Fsmc<'a, ChipSpecs>,
    pub gpio_ports: crate::gpio::GpioPorts<'a, ChipSpecs>,
    pub i2c1: crate::i2c::I2C<'a, ChipSpecs>,
    pub clocks: &'a crate::clocks::Clocks<'a, ChipSpecs>,
    pub spi3: crate::spi::Spi<'a, ChipSpecs>,
    pub tim2: crate::tim2::Tim2<'a, ChipSpecs>,
    pub usart1: crate::usart::Usart<'a, ChipSpecs, dma::Dma2<'a, ChipSpecs>>,
    pub usart2: crate::usart::Usart<'a, ChipSpecs, dma::Dma1<'a, ChipSpecs>>,
    pub usart3: crate::usart::Usart<'a, ChipSpecs, dma::Dma1<'a, ChipSpecs>>,
}
...
impl<'a, ChipSpecs: ChipSpecsTrait> Stm32f4xxDefaultPeripherals<'a, ChipSpecs> {
    pub fn new(
        ...
        exti: &'a crate::exti::Exti<'a, ChipSpecs>,
        dma1: &'a dma::Dma1<'a, ChipSpecs>,
        dma2: &'a dma::Dma2<'a, ChipSpecs>,
    ) -> Self {
        Self {
            ...
            spi3: crate::spi::Spi::new_spi3(clocks),
